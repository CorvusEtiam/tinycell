...
pub const AppError = error{parseExprError, outOfBoundAccess};
...
pub fn parseCellFromString(str: []const u8, alloc: std.mem.Allocator) Cell {
    ...
    if ( str.len == 0 ) {
        ...
        var parser = expressions.Parser.init(trimmed[1..], alloc);
        return Cell {
            .as = .{
...
pub fn main() anyerror!void {
    ...
    var command_options = utils.CommandOptions.parse(allocator) catch {
